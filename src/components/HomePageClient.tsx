      ...
      <section id="kits" className="mx-auto w-full max-w-6xl px-6 pb-24 sm:px-8">
        ...
        {whopKitAppUrl ? (
          <div className="mt-6 rounded-2xl border border-amber-300/25 bg-amber-300/5 px-5 py-4 text-center sm:text-left">
            ...
            <a
              href={whopKitAppUrl}
              className="mt-3 inline-flex max-w-full break-all text-sm font-medium text-amber-200 underline-offset-4 hover:underline"
            >
              {whopKitAppUrl}
            </a>
          </div>
